// version: 2019-12-05
    ...
    RGraph.Bar = function (conf)
    {
        ...
        this.drawAxes = function ()
        {
            ...
            //
            //if (!prop.yaxis && prop.xaxis && RGraph.isNull(prop.xaxisTickmarksCount) && !isSketch) {
            //    if (xaxispos == 'center') {
    ...
    : (this.data[i] > 0 ?
        ...
        this.drawLabels = function ()
        {
            ...
            if (prop.yaxisLabels) {
                ...
                else if (prop.xaxisPosition === 'center') { this.drawlabels_center(); }
                else                                      { this.drawlabels_bottom(); }
            }
        ...
        this.getShape = function (e)
        {
            ...
            for (var i=0,len=coords.length; i<len; i+=1) {
                ...
                if (prop.tooltipsHotspotXonly) {
                    this.path({
                        path: 'b r % % % %',
                        args: [left, this.marginTop, width, this.canvas.height - this.marginBottom]
                    });
                } else {
                     this.path({
                        path: 'b r % % % %',
                ...
                if (this.context.isPointInPath(mouseX, mouseY)) {
                    ...
                    if (prop.tooltips && RGraph.parseTooltipText) {
