            ...
            if (prop.variant.indexOf('3d') !== -1) {
                ...
                for (var i=prop.variantThreedDepth; i>0; i-=1) {
                    ...
                    for (var j=0,len=this.angles.length; j<len; j+=1) {
                       ...
                       this.path({
                            path: 'b m % % a % % % % % false c f rgba(0,0,0,0.1) c f rgba(0,0,0,0.1)',
                            args: [
                                a[4], a[5],
        ...
        this.getShape = function (e)
        {
            ...
            for (var i=0; i<angles.length ; ++i) {
                ...
                if (this.context.isPointInPath(mouseXY[0], mouseXY[1])) {
                    ...
                    //
                    // TODO Are these really necessary any more?
                    //
                    ...
                    angles[i].index           = typeof this.data[indexes[0]] === 'number'  ? indexes[0] : indexes[1];
                    angles[i].dataset         = typeof this.data[indexes[0]] === 'number'  ? indexes[1] : indexes[0],
                    ...
                    if (prop.variant === 'non-equi-angular') {
                        angles[i].dataset = 0;
                        angles[i].index   = angles[i].sequentialIndex;
                    }
